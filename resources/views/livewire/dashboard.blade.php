                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">{{__('Available beds')}}</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        {{\App\Models\Offer::sum('amount')}}
                                    </h5>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">{{__('Supporters')}}</p>
                                    <h5 class="font-weight-bolder mb-0">
