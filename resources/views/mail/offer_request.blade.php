...
<br>
{{__('If your offer is still available, please directly get in touch with')}} <b>{{$requester_name}}</b>. {{__('We advise you to only to reply to the e-mail address for this and not to open any links from the message')}}.
<br><br>
